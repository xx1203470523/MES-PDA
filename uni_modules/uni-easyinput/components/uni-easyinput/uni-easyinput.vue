	...
	<view class="uni-easyinput" :class="{ 'uni-easyinput-error': msg }" :style="boxStyle">
		<view class="uni-easyinput__content" :class="inputContentClass" :style="inputContentStyle">
			<slot name="prefixIcon">
				<uni-icons v-if="prefixIcon" class="content-clear-icon" :type="prefixIcon" color="#409EFF"
					@click="onClickIcon('prefix')" size="22"></uni-icons>
			</slot>
			<textarea v-if="type === 'textarea'" ref="textareaInput" class="uni-easyinput__content-textarea"
				:class="{ 'input-padding': inputBorder }" :name="name" :value="val" :placeholder="placeholder"
				:placeholderStyle="placeholderStyle" :disabled="disabled" :auto-focus="autofocus"
			...
			<input v-else ref="simpleInput" :type="type === 'password' ? 'text' : type"
