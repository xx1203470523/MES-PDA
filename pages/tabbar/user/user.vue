<template>
	<view class="user" :style="{'min-height' : pageHeight + 'px'}">
		<pda-nav title="我的">
			<template #left>
				<view class="nav-left">
					<view class="nav-left-content" @tap.stop="openWarehouseSetting">
						<tui-overflow-hidden width="300rpx" line-clamp="1">
							{{ page.warehouse.data ? page.warehouse.data.warehouseName : '未选择仓库' }}
							<tui-icon :size="16" name="arrowdown"></tui-icon>
						</tui-overflow-hidden>
					</view>
				</view>
			</template>
